...
BASE_TOKEN = os.getenv("AUTUMN_JOBS_BASE_TOKEN", "REDACTED_FEISHU_BASE_TOKEN")
TABLE_ID = os.getenv("AUTUMN_JOBS_TABLE_ID", "REDACTED_TABLE_ID")
VIEW_ID = os.getenv("AUTUMN_JOBS_VIEW_ID", "REDACTED_VIEW_ID")
FIELDS = ["公司", "开始时间"]
LIMIT = 200
